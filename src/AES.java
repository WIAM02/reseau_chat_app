...
//    public static SecretKey generateRandomAESKey(int keySize) throws NoSuchAlgorithmException {
//        // Determine the key size in bytes (e.g., 16 bytes for AES-128)
//        int keySizeBytes = keySize / 8;
//
//        // Initialize SecureRandom for generating random bytes
